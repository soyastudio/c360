...
@Service
@Slf4j
public class C360CustomerProfileV3Service {

    private ApplicationProperties applicationProperties;
    private UserProfileAccessLayerV3 userProfileAccessLayer;
    ...
    public C360CustomerProfileV3Service(@Qualifier("UserProfileDaoImpl") UserProfileAccessLayerV3 userProfileAccessLayer,
    ...
    public ResponseEntity<Mono<CustomerProfileResponse>> getProfileData(String customerUUID) {
        String cacheKey = "V3"+customerUUID;
        counter.increment();
